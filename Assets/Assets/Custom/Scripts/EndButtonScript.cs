...
public class EndButtonScript : MonoBehaviour
{
    ...
    public void TaskOnClick()
    {
        ...
        if(evaluator.playerS < 0.2){
            scar.text = "<color=#FF0000>S :</color> Cette decision est grave";
        } else if (evaluator.playerS < 0.4){
            scar.text = "<color=#FF0000>S :</color> Cette decision est mauvaise";
        } else if (evaluator.playerS < 0.6){
            scar.text = "<color=#FF0000>S :</color> Cette decision est moyenne";
        } else if (evaluator.playerS < 0.8){
            scar.text = "<color=#FF0000>S :</color> Cette decision est bonne";
        } else {
            scar.text = "<color=#FF0000>S :</color> Cette decision est parfaite";
        }

        if(evaluator.playerC < 0.2){
            scar.text = scar.text + "\n\n" + "<color=#FEFF00>C :</color> Cette decision est grave";
        } else if (evaluator.playerC < 0.4){
            scar.text = scar.text + "\n\n" + "<color=#FEFF00>C :</color> Cette decision est mauvaise";
        } else if (evaluator.playerC < 0.6){
            scar.text = scar.text + "\n\n" + "<color=#FEFF00>C :</color> Cette decision est moyenne";
        } else if (evaluator.playerC < 0.8){
            scar.text = scar.text + "\n\n" + "<color=#FEFF00>C :</color> Cette decision est bonne";
        } else {
            scar.text = scar.text + "\n\n" + "<color=#FEFF00>C :</color> Cette decision est parfaite";
        }

        if(evaluator.playerA < 0.2){
            scar.text = scar.text + "\n\n" + "<color=#00FF33>A :</color> Cette decision est grave";
        } else if (evaluator.playerA < 0.4){
            scar.text = scar.text + "\n\n" + "<color=#00FF33>A :</color> Cette decision est mauvaise";
        } else if (evaluator.playerA < 0.6){
            scar.text = scar.text + "\n\n" + "<color=#00FF33>A :</color> Cette decision est moyenne";
        } else if (evaluator.playerA < 0.8){
            scar.text = scar.text + "\n\n" + "<color=#00FF33>A :</color> Cette decision est bonne";
        } else {
            scar.text = scar.text + "\n\n" + "<color=#00FF33>A :</color> Cette decision est parfaite";
        }

        if(evaluator.playerR < 0.2){
            scar.text = scar.text + "\n\n" + "<color=#003DFF>R :</color> Cette decision est grave";
        } else if (evaluator.playerR < 0.4){
            scar.text = scar.text + "\n\n" + "<color=#003DFF>R :</color> Cette decision est mauvaise";
        } else if (evaluator.playerR < 0.6){
            scar.text = scar.text + "\n\n" + "<color=#003DFF>R :</color> Cette decision est moyenne";
        } else if (evaluator.playerR < 0.8){
            scar.text = scar.text + "\n\n" + "<color=#003DFF>R :</color> Cette decision est bonne";
        } else {;
            scar.text = scar.text + "\n\n" + "<color=#003DFF>R :</color> Cette decision est parfaite";
        }
